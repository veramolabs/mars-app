    ...
    <Card elevation={2}>
      ...
      <CardActions disableSpacing>
        <Typography variant="body2" color="textPrimary">
          {message.createdAt && formatDistanceToNow(Date.parse(message.createdAt))} ago, type: {message.type},
          Credentials: {message.credentials?.length}, Presentations: {message.presentations?.length}
        </Typography>
